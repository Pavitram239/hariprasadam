...
import { CATEGORIES_DATA, PRODUCTS, SIGNATURE_COMBOS } from '@/lib/productsData';
import { GIFT_BOXES_2026 } from '@/lib/giftingData';
...
export default function HomePage() {
  ...
  // Filter signature flavour products
    ...
    <div className="space-y-24 sm:space-y-32 pb-24 overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-[#5C5047] max-w-xl leading-relaxed">
              Crafted in Surat, Gujarat. Discover whole select nuts, slow-roasted dry fruits, and an iconic 27-flavour collection — thoughtfully presented for celebratory milestones and bespoke corporate gifting.
            </p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          subtitle="Explore the six core pillars of our artisanal range, each roasted and flavoured to perfection."
        />
                ...
                <div className="relative aspect-[4/3] bg-[#F7F4EE] overflow-hidden">
                  ...
                  <div className="absolute bottom-3 left-4 text-white">
                    <span className="text-[10px] uppercase font-bold tracking-[0.2em] text-[#C59B3F] block">
                      {category.flavoursCount} Flavours
                    </span>
      ...
      <section className="bg-[#140F0E] text-[#FAF8F5] py-20 lg:py-28 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="mt-12 text-center">
            ...
            >
              <span>Browse All 27 Flavours in Complete Catalogue</span>
      ...
      <section className="bg-[#FAF8F5] py-16 lg:py-24 border-y border-[#E6DEC8]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeading
            ...
            subtitle="Eight tailored combinations thoughtfully engineered for festive occasions, chocolate indulgence, Indian palates, and everyday wellness."
          />
