...
import { PRODUCTS, CATEGORIES_DATA } from '@/lib/productsData';
...
function ProductsCatalogContent() {
  ...
  const categories = ['All', 'Almond', 'Cashew', 'Dates', 'Raisin', 'Hazelnut', 'Mixes & Blends'];
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20 space-y-12">
      ...
      <SectionHeading
        ...
        subtitle="27 distinct flavours across 6 categories. Freshly dry-roasted and coated to order with premium spices, rich chocolates, and floral nectar glazes."
      />
      ...
      {filteredProducts.length > 0 ? (
        ...
        <div className="bg-white border border-[#E6DEC8] rounded-xl p-12 text-center space-y-4">
          ...
          <button
            ...
            className="px-4 py-2 text-xs font-semibold bg-[#1A1412] text-[#FAF8F5] rounded-md"
          >
            Reset Filters
          </button>
        </div>
      ...
      <div className="bg-[#FAF8F5] border border-[#E6DEC8] rounded-xl p-8 text-center space-y-4 max-w-3xl mx-auto">
        ...
        <div>
          <button
            ...
            className="px-6 py-2.5 bg-[#1A1412] hover:bg-[#2C221E] text-[#FAF8F5] text-xs font-semibold rounded-md transition-colors"
          >
