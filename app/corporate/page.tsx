...
import { Building2, Sparkles, ArrowRight, CheckCircle2, ShieldCheck, Users, Briefcase, Award, Palette, PackageCheck } from 'lucide-react';
    ...
    <div className="space-y-20 sm:space-y-28 pb-24">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 text-center">
            <button
              ...
              className="px-8 py-3.5 bg-[#1A1412] hover:bg-[#2C221E] text-[#FAF8F5] text-sm font-semibold rounded-md shadow transition-colors inline-flex items-center space-x-2 border border-[#C59B3F]/40"
            >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {GIFT_BOXES_2026.slice(0, 3).map((box) => (
        ...
        <div className="bg-[#1A1412] text-[#FAF8F5] rounded-2xl p-8 sm:p-12 border border-[#C59B3F]/30 shadow-xl flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex flex-col sm:flex-row gap-3 shrink-0">
            <button
              ...
              className="px-6 py-3 bg-[#C59B3F] hover:bg-[#b88c32] text-[#140F0E] text-xs font-bold uppercase tracking-wider rounded transition-colors"
            >
